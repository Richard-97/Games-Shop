...
class FilterXBOX extends Component{
    constructor(){
        super();
        this.state = {
    ...
    renderGames = () => {
            return this.props.data.gameXBOX.map( (game, i) => {
                return (
                     <SaleCard consoleType={"XBOX"} name={game.name} price={game.price}/>
                )
            } )
...
export default graphql(getData)(FilterXBOX);