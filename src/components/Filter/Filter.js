...
class Filter extends Component{
    ...
    componentWillMount(){
        this.setState({gameConsole: this.props.gameConsole});
    }
    ...
    renderGames = () => {
            return this.props.data.gamePS4.map( (game, i) => {
                return (
                     <SaleCard consoleType={"PS4"} name={game.name} price={game.price}/>
                )
            } )
...
export default graphql(getData)(Filter);